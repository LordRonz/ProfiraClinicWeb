...
namespace ProfiraClinicWebAPI.Controllers
{
        ...
        : BaseCrudController<Barang>
    {
        ...
        protected override DbSet<Barang> DbSet => _context.Barang;

        protected override IQueryable<Barang> ApplySearch(IQueryable<Barang> q, string likeParam)
            => q.Where(d =>
                EF.Functions.Like(d.KodeBarang, likeParam) ||
                EF.Functions.Like(d.NamaBarang, likeParam));

        protected override IOrderedQueryable<Barang> ApplyOrder(IQueryable<Barang> q)
